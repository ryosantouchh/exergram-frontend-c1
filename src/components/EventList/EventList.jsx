...
// const endpoint  = "http://localhost:5000/api/events";
...
// ];
const EventList = () => {
  // fetch event data from backend and store in allEvents variable as array of objects (each object is an event)
  // const allEvents = fetchEventFromBackend();
